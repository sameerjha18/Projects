    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="top-right-button-container">
                    ...
                    <button type="button" class="btn btn-outline-warning" data-toggle="modal" data-backdrop="static" data-target="#add_brand">Add Brand List</button>
                    <div class="btn-group">
        ...
        <div class="row">
            <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                <?php
                if($this->session->flashdata('brandmsg')){
                    ?>
                    <div class="alert alert-success mb-2" role="alert">
                        ...
                        <?php
                        echo $this->session->flashdata('brandmsg');
                        ?>
                    </div>
                    <?php
                }
                ...
                <table id="datatableRows" class="data-table responsive nowrap" data-order="[[ 0, &quot;asc&quot; ]]">
                    ...
                    <tbody>
                    <?php
                    if(is_array($b_list) && !empty($b_list))
                    {
                        $i = 1;
                        foreach($b_list as $val)
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a for ="<?php echo $val->b_id; ?>" class="search_brand"  data-csrf_token_name ="<?php echo $this->security->get_csrf_token_name(); ?>" data-csrf_token_hash = "<?php echo $this->security->get_csrf_hash(); ?>">
...
<div class="modal fade modal-right" id="add_brand" tabindex="-1" role="dialog" aria-labelledby="add_brand" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Brand List</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <?php
                $attributes = array('class' => 'form', 'id' => 'add_brandform');
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" id ="brand">Submit</button>
...
<div class="modal fade modal-right" id="update_brand" tabindex="-1" role="dialog" aria-labelledby="update_brand" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Update Brand List</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <?php
                $attributes = array('class' => 'form', 'id' => 'update_brandform');
                echo form_open('', $attributes);
                ?>
                <div class="form-group">
                    <label>Brand</label>
                    <input type="text" class="form-control" name = "brand" id="b_name" placeholder="Brand Name"/>
                    <input type="hidden" class="form-control" name = "b_id" id="b_id" >
                </div>
                <div class="form-group">
                    <label>Status</label>
                    <select class="form-control" name="status" id="b_status">
                        <option label="&nbsp;">&nbsp;</option>
                        <option value="1" selected="">Active</option>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" id ="updatebrand">Submit</button>
                <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
