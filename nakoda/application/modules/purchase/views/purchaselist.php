            ...
            <div class="row">
               <div class="col-12">
                  ...
                  <div class="top-right-button-container">
                     ...
                     <a class="btn btn-primary btn-min-width box-shadow-1 mr-1 mb-1 sidebar-right" href="<?php echo base_url(); ?>purchase/add_purchase">Add Purchase</a>
                     <div class="btn-group">
            ...
            <div class="row">
               <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                  ...
                  <table id="datatableRows" class="data-table responsive nowrap" data-order="[[ 0, &quot;asc&quot; ]]">
                     ...
                     <tbody>
                           <?php
                              if(is_array($purchase_list) && !empty($purchase_list))
                              {
                                 $i = 1;
                           ...
                           <tr>
                              <td><?php echo $i; ?></td>
                              <td><?php echo date('d-m-Y',strtotime($val->purchase_date)); ?></td>
                              <td><?php echo $val->sp_id; ?></td>
                              <td>
                                  <a href="<?php echo base_url(); ?>purchase/purchasedetail/<?php echo $val->purchase_id; ?>"><i class="simple-icon-pencil" title="purchasedetail"></i></a>
                              </td>
                              <td>
                                 <?php 
                                 if($val->purchase_status=='1'){
                                    echo "Working";
                                 }
                                 else{ 
                                    echo "Not-Working"; }
                              ...
                              <td>
                                  <a href="<?php echo base_url(); ?>purchase/update_purchase/<?php echo $val->purchase_id; ?>"><i class="simple-icon-pencil" title="Update"></i></a>
                              </td>
                           </tr>
                        <?php
                        $i++;
