    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb pt-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Product Types List</li>
                    </ol>
                </nav>
                <div class="top-right-button-container">

                    <button type="button" class="btn btn-outline-warning" data-toggle="modal" data-backdrop="static" data-target="#add_type">Add Product Types</button>
                    <div class="btn-group">
        ...
        <div class="row">
            <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                <?php
                if($this->session->flashdata('typemsg')){
                    ?>
                    <div class="alert alert-success mb-2" role="alert">
                        ...
                        <?php
                        echo $this->session->flashdata('typemsg');
                        ?>
                    </div>
                    <?php
                }
                ...
                <table id="datatableRows" class="data-table responsive nowrap" data-order="[[ 0, &quot;asc&quot; ]]">
                    ...
                    <tbody>
                    <?php
                    if(is_array($t_list) && !empty($t_list))
                    {
                        $i = 1;
                        foreach($t_list as $val)
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a for ="<?php echo $val->t_id; ?>" class="search_type"  data-csrf_token_name ="<?php echo $this->security->get_csrf_token_name(); ?>" data-csrf_token_hash = "<?php echo $this->security->get_csrf_hash(); ?>">
...
<div class="modal fade modal-right" id="add_type" tabindex="-1" role="dialog" aria-labelledby="add_type" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Product Types List</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <?php
                $attributes = array('class' => 'form', 'id' => 'add_producttypeform');
                echo form_open('', $attributes);
                ?>
                <div class="form-group">
                    <label>Product Types</label>
                    <input type="text" class="form-control" name = "ptype" placeholder="Product Types"/>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" id ="ptype">Submit</button>
...
<div class="modal fade modal-right" id="update_type" tabindex="-1" role="dialog" aria-labelledby="update_type" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Update product types</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <?php
                $attributes = array('class' => 'form', 'id' => 'update_producttypeform');
                echo form_open('', $attributes);
                ?>
                <div class="form-group">
                    <label>Product Types</label>
                    <input type="text" class="form-control" name = "ptype" id="p_type" placeholder="Products Types"/>
                    <input type="hidden" class="form-control" name = "p_id" id="p_id" >
                </div>
                <div class="form-group">
                    <label>Descriptions</label>
                    <input type="text" class="form-control" name = "desc" id="p_desc" placeholder="Product Desc"/>
                </div>
                <div class="form-group">
                    <label>Status</label>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" id ="updateproducttype">Submit</button>
                <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
