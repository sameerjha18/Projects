	...
	public function index()
	{
		...
		if($this->input->post('isAjax')=='1')
		{
			...
			if($this->form_validation->run()==FALSE):
				...
				$conditionArray = array('s_name'=>strtolower($record['username']),'s_password'=>$record['userpassword']);
				$logindata = $this->admin_model->getWhere('staff',$conditionArray);
		...
		else
		{
			...
			{
				redirect(base_url().'stafflogin/dashboard');
			}
			else
			{
