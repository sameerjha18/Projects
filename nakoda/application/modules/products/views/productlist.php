            ...
            <div class="row">
               <div class="col-12">
                  ...
                  <div class="top-right-button-container">
                     ...
                     <a class="btn btn-primary btn-min-width box-shadow-1 mr-1 mb-1 sidebar-right" href="<?php echo base_url(); ?>products/add_products">Add Product</a>
                     <div class="btn-group">
                  ...
                  <table id="datatableRows" class="data-table responsive nowrap" data-order="[[ 0, &quot;asc&quot; ]]">
                     ...
                     <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                  <a href="<?php echo base_url(); ?>products/update_products/<?php echo $val->p_id; ?>"><i class="simple-icon-pencil" title="Update"></i></a>
                              </td>
                           </tr>
                        <?php
                        $i++;
