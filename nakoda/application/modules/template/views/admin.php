    ...
    <div class="main-menu">
        <div class="scroll">
            <ul class="list-unstyled">
                ...
                <li><a href="<?php echo base_url().'billing/add_bill';?>"><i class="iconsminds-billing"></i>Billings</a>
                </li>
        ...
        <div class="scroll">
            <ul class="list-unstyled"data-link="management" id="management">
                <?php if(in_array('1',$admin_roles)): ?>
                    <li class= "<?php if ($function =='dimension'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'dimension';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Dimension</span></a>
                    </li>
                <?php endif;?>
                ...
                <?php if(in_array('4',$admin_roles)): ?>
                    <li class= "<?php if ($function =='colour'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'colour';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Colour</span></a>
                    </li>
                <?php endif;?>
                <?php if(in_array('5',$admin_roles)): ?>
                    <li class= "<?php if ($function =='brand'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'brand';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Brands</span></a>
                    </li>
                <?php endif;?>
                <?php if(in_array('6',$admin_roles)): ?>
                    <li class= "<?php if ($function =='purchase'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'purchase';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Purchase</span></a>
                    </li>
                <?php endif;?>
                <?php if(in_array('7',$admin_roles)): ?>
                    <li class= "<?php if ($function =='supplier'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'supplier';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Suppliers</span></a>
                    </li>
                <?php endif;?>
                <?php if(in_array('8',$admin_roles)): ?>
                    <li class= "<?php if ($function =='product Types'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'producttype';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Product Types</span></a>
                    </li>
                <?php endif;?>
                <?php if(in_array('9',$admin_roles)): ?>
                    <li class= "<?php if ($function =='inventory'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'inventory';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Product Available</span></a>
                    </li>
                <?php endif;?>
            </ul>
