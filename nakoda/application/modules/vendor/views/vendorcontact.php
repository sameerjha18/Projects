            ...
            <div class="col-12">
                ...
                <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb pt-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url().'vendor'; ?>">Vendor List</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Vendor Contact</li>
                    </ol>
                </nav>
                <div class="top-right-button-container">

                    <button type="button" class="btn btn-outline-warning" data-toggle="modal" data-backdrop="static" data-target="#add_vendorcontact">Add Vendor Contact</button>
...
<div class="modal fade modal-right" id="update_vendorcontact" tabindex="-1" role="dialog" aria-labelledby="update_vendorcontact" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Update New Vendor</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
