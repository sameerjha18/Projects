         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-12">
                  ...
                  <div class="top-right-button-container">
                     ...
                     <button type="button" class="btn btn-outline-warning" data-toggle="modal" data-backdrop="static" data-target="#add_staffmodal">Add Staff</button>
                     <div class="btn-group">
            ...
            <div class="row">
               <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                    <?php
                       if($this->session->flashdata('Staffmsg')){
                       ?>
                         <div class="alert alert-success mb-2" role="alert">
                           ...
                           <?php
                               echo $this->session->flashdata('Staffmsg');
                           ?>
                         </div>
                       <?php
                        }
                     ...
                     <tbody>
                        ...
                        ?>
                           <tr>
                              ...
                              <td><?php echo $val->s_mobile; ?></td>
                              <td><?php echo $val->s_email; ?></td>
                              <td>
                                 <?php 
                                 if($val->s_status=='1'){
                                    echo "Active";
                              ...
                              <td>
                                 <a for ="<?php echo $val->s_id; ?>" class="search_staff"  data-csrf_token_name ="<?php echo $this->security->get_csrf_token_name(); ?>" data-csrf_token_hash = "<?php echo $this->security->get_csrf_hash(); ?>">
...
<div class="modal fade modal-right" id="add_staffmodal" tabindex="-1" role="dialog" aria-labelledby="add_staffmodal" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<?php
					$attributes = array('class' => 'form', 'id' => 'add_staffform');
            ...
            <button type="submit" class="btn btn-primary" id ="add_staff">Submit</button>
...
<div class="modal fade modal-right" id="update_staffmodal" tabindex="-1" role="dialog" aria-labelledby="update_staffmodal" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
         ...
         <div class="modal-body">
            <?php
               $attributes = array('class' => 'form', 'id' => 'update_staffform');
               echo form_open('', $attributes);
            ?>
               <div class="form-group">
                  <label>Name*</label>
               ...
               <div class="form-group">
                  <label>Mobile*</label>
                  <input type="text" class="form-control" name = "smobile" id = "smobile">
               </div>
               <div class="form-group">
                  <label>Alternate Mobile</label>
         ...
         <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary" id ="update_staffManagement">Submit</button>
            <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Cancel</button>
         </div>
      </div>
   </div>
