        ...
        <div class="col-12">
            <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                <ol class="breadcrumb pt-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url() . 'inquiry/allinquiry'; ?>">All Inquiry</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url() . 'inquiry/inspectiondetails/'.$inq_id; ?>">Inspection Details</a></li>
