         ...
         <div class="container-fluid">
                ...
                <?php
                  ...
                  <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb pt-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Client Sites</li>
                    </ol>
                </nav>
                  <div class="top-right-button-container">
                     <a class="btn btn-primary btn-min-width box-shadow-1 mr-1 mb-1 sidebar-right" href="<?php echo base_url(); ?>clientmanagement/add_site/<?php echo $id;?>">Add Sites</a>
                     <div class="btn-group">
            ...
            <div class="row">
               <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                    <?php
                       if($this->session->flashdata('clientsitemsg')){
                       ?>
                         <div class="alert alert-success mb-2" role="alert">
                           ...
                           <?php
                               echo $this->session->flashdata('clientsitemsg');
                           ?>
                         </div>
                       <?php
                        }
                  ...
                  <table id="datatableRows" class="data-table responsive nowrap" data-order="[[ 0, &quot;asc&quot; ]]">
                     ...
                     <tbody>
                        <?php
                           if(is_array($site_list) && !empty($site_list))
                           {
                              $i = 1;
                        ...
                        ?>
                           <tr>
                              ...
                              <td><?php echo $val->site_address; ?></td>
                               <td>
                                  <a href="<?php echo base_url(); ?>clientmanagement/documents/<?php echo $val->client_id; ?>"><i class="simple-icon-pencil" title="Update"></i></a>
                              </td>
         
                              <td>
                                  <a href="<?php echo base_url(); ?>clientmanagement/update_site/<?php echo $id;?>/<?php echo $val->site_id; ?>"><i class="simple-icon-pencil" title="Update"></i></a>
                              </td>
                           </tr>
                        <?php
                        $i++;
