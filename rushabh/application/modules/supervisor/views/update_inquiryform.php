        ...
        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <textarea name="area" id="area" class="form-control" cols="5" rows="3"><?php echo $inquirydetail[0]->inqd_area; ?></textarea>
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea name="jp" id="jp" cols="5" rows="3" class="form-control"><?php echo $inquirydetail[0]->inqd_jp; ?></textarea>
                </div>
                <div class="form-group col-md-6">
            ...
            <a href="<?php echo base_url() . 'supervisor/inspectiondetails/'.$inquirydetail[0]->inq_id; ?>" class="btn btn-danger mr-1">
                <i class="ft-x"></i> Back
            </a>
            <?php echo form_close(); ?>
        </div>
