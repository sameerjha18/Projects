            ...
            <div class="row">
               <div class="col-12">
                  ...
                  <div class="top-right-button-container">
                     ...
                     <a class="btn btn-primary btn-min-width box-shadow-1 mr-1 mb-1 sidebar-right" href="<?php echo base_url(); ?>vendor/add_vendor">Add Fabricator</a>
                     <div class="btn-group">
                        ...
                        ?>
                           <tr>
                              ...
                              <td><?php echo $val->v_mobile; ?></td>
                               ...
                               <td><a href="<?php echo base_url().'vendor/productspecialized/'.$val->v_id; ?>"><i class="simple-icon-pencil"></i></a></td>
                              <td>
                                 <?php 
                                 if($val->v_status=='1'){
                                    echo "Working";
