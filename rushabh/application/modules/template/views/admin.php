...
<nav class="navbar fixed-top">
    ...
    <div class="navbar-right">
        <div class="user d-inline-block">
            <button class="btn btn-empty p-0" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="name"><?php echo $this->session->userdata('adminName'); ?></span>  <span><img alt="Profile Picture" src="<?php echo base_url().'app-assets/img/profiles/l-1.jpg'?>"></span>
            </button>
    ...
    <div class="main-menu">
        <div class="scroll">
            <ul class="list-unstyled">
                <li <?php if($function == 'dashboard'): ?> class= "active"<?php endif;?>><a href="<?php echo base_url().'admin/dashboard';?>"><i class="iconsminds-shop-4"></i> <span>Dashboard</span></a>
                </li>
                <li><a href="#management"><i class="iconsminds-digital-drawing"></i> Management</a>
                </li>
                <li><a href="<?php echo base_url().'clientmanagement';?>"><i class="iconsminds-user"></i>Clients</a>
                </li>
                <li><a href="<?php echo base_url().'purchase';?>"><i class="simple-icon-basket"></i>Purchase</a>
                </li>
                <li><a href="<?php echo base_url().'inquiry';?>"><i class="iconsminds-pantone"></i>Inquiry</a>
                </li>
                <li><a href="<?php echo base_url().'quotation';?>"><i class="iconsminds-pantone"></i>Quotation</a>
                </li>
                <li><a href="#sites"><i class="iconsminds-support"></i>Sites</a>
                </li>
        ...
        <div class="scroll">
            <ul class="list-unstyled"data-link="management" id="management">
                <?php if(in_array('4',$admin_roles)): ?>
                    <li class= "<?php if ($function =='expensetype'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'expensetype';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Expense Type</span></a>
                    </li>
                <?php endif;?>
                <?php if(in_array('6',$admin_roles)): ?>
                    <li class= "<?php if ($function =='products'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'products';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Products</span></a>
                    </li>
                <?php endif;?>
                <?php if(in_array('2',$admin_roles)): ?>
                    <li class= "<?php if ($function =='supervisormanagement'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'supervisormanagement';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Supervisor Management</span></a>
                    </li>
                <?php endif;?>
                <?php if(in_array('3',$admin_roles)): ?>
                    <li class= "<?php if ($function =='staffmanagement'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'staffmanagement';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Staff Management</span></a>
                    </li>
                <?php endif;?>
                <?php if(in_array('5',$admin_roles)): ?>
                    <li class= "<?php if ($function =='supplier'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'supplier';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Supplier</span></a>
                    </li>
                <?php endif;?>
                <?php if(in_array('1',$admin_roles)): ?>
                    <li class= "<?php if ($function =='quotation'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'quotationtemplate/template';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Quote Tempate</span></a>
                    </li>
                <?php endif;?>
                <?php if(in_array('1',$admin_roles)): ?>
            ...
            <?php if(in_array('7',$admin_roles)): ?>
                    <li class= "<?php if ($function =='working'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'working';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Working</span></a>
                    </li>
                <?php endif;?>
                <?php if(in_array('8',$admin_roles)): ?>
                    <li class= "<?php if ($function =='completed'): {?>active<?php } ?> <?php endif; ?>" >
                        <a href="<?php echo base_url().'completed';?>"><i class="simple-icon-book-open"></i> <span class="d-inline-block">Completed</span></a>
                    </li>
                <?php endif;?>
            </ul>
