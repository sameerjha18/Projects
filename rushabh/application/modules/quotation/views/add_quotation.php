	<main> 
		<div class="card mb-4"> 
			<div class="card-body"> 
				...
				<?php $attributes = array('class' => 'form', 'id' => 'add_quotationform'); 
				...
				<div class="form-actions"> 
					<button type="submit" id="add_quotation" class="btn btn-primary"> <i class="la la-check-square-o"></i> Save </button> 
