    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb pt-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Mode List</li>
                    </ol>
                </nav>
                <div class="top-right-button-container">

                    <button type="button" class="btn btn-outline-warning" data-toggle="modal" data-backdrop="static" data-target="#add_expense">Add Expense Mode</button>
                    <div class="btn-group">
        ...
        <div class="row">
            <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                <?php
                if($this->session->flashdata('expensemsg')){
                    ?>
                    <div class="alert alert-success mb-2" role="alert">
                        ...
                        <?php
                        echo $this->session->flashdata('expensemsg');
                        ?>
                    </div>
                    <?php
                }
                ...
                <table id="datatableRows" class="data-table responsive nowrap" data-order="[[ 0, &quot;asc&quot; ]]">
                    ...
                    <tbody>
                    <?php
                    if(is_array($ex_list) && !empty($ex_list))
                    {
                        $i = 1;
                        foreach($ex_list as $val)
                        {
                            ?>
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td><?php echo $val->ex_type; ?></td>
                                <td><?php echo $val->ex_desc; ?></td>
                                <td>
                                    <a for ="<?php echo $val->ex_id; ?>" class="search_expensetype"  data-csrf_token_name ="<?php echo $this->security->get_csrf_token_name(); ?>" data-csrf_token_hash = "<?php echo $this->security->get_csrf_hash(); ?>">
...
<div class="modal fade modal-right" id="add_expense" tabindex="-1" role="dialog" aria-labelledby="add_expense" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                $attributes = array('class' => 'form', 'id' => 'add_expenseform');
                echo form_open('', $attributes);
                ?>
                <div class="form-group">
                    <label>Expense Type*</label>
                    <input type="text" class="form-control" name = "Expensetype" placeholder="Expense Type"/>
                </div>
                <div class="form-group">
                    <label>Status</label>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" id ="expensetype">Submit</button>
...
<div class="modal fade modal-right" id="update_expensetype" tabindex="-1" role="dialog" aria-labelledby="update_expensetype" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <?php
                $attributes = array('class' => 'form', 'id' => 'update_expenseform');
                echo form_open('', $attributes);
                ?>
                <div class="form-group">
                <label>Expense Type*</label>
                    <input type="text" class="form-control" id="u_expense" name = "epensetype" placeholder="Expense Type"/>
                    <input type="hidden" class="form-control" name = "ex_id" id="ex_id" >
                </div>
                <div class="form-group">
                    <label>Status</label>
                ...
                <div class="form-group">
                    <label>Description</label>
                    <textarea rows="4" cols="50" id="u_desc" name="desc"class="form-control" ></textarea>
                </div>

                <?php echo form_close(); ?>
            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" id ="update_expense">Submit</button>
                <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
