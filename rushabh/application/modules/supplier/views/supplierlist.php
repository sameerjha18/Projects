                  ...
                  ?>
                     <tr>
                        ...
                        <td><?php echo $val->s_mobile; ?></td>
                         ...
                         <td><a href="<?php echo base_url().'supplier/suppliercontact/'.$val->s_id; ?>"><i class="simple-icon-pencil"></i></a></td>
                         <td><a href="<?php echo base_url().'supplier/productsupplierlist/'.$val->s_id; ?>"><i class="simple-icon-pencil"></i></a></td>
                        <td>
                           <?php 
                           if($val->s_status=='1'){
                              echo "Working";
                        ...
                        <td>
                            <a href="<?php echo base_url(); ?>supplier/update_supplier/<?php echo $val->s_id; ?>"><i class="simple-icon-pencil" title="Update"></i></a>
                        </td>
                     </tr>
                  <?php
                        }
