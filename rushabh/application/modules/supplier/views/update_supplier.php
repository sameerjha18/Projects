        ...
        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
            ...
            <div class="form-row">
                ...
                <label for="companyinput1" id="cust_update">Supplier Name*</label>
                            <input type="text" name="uname" class="form-control" placeholder=" Supplier Name" value="<?php echo $category[0]->s_name; ?>" />

                            <input type="hidden" class="form-control" id="sp_id" name="sp_id" value="<?php echo $category[0]->s_id; ?>" />
                </div>
                <div class="form-group col-md-6">
                <label for="companyinput1" id="cust_update">Address 1*</label>
                            <input type="text" name="uaddress1" class="form-control" placeholder="Address 1" value="<?php echo $category[0]->s_address1; ?>" />
                </div>

                <div class="form-group col-md-6">
                <label for="companyinput1" id="cust_update">Address 2</label>
                            <input type="text" name="uaddress2" class="form-control" placeholder="Address 2" value="<?php echo $category[0]->s_address2; ?>" />
                </div>
                <div class="form-group col-md-6">
                <label for="companyinput1" id="cust_update">Address 3</label>
                            <input type="text" name="uaddress3" class="form-control" placeholder="Address 3" value="<?php echo $category[0]->s_address3; ?>" />
                </div>
                <div class="form-group col-md-6">
                ...
                <label for="companyinput1" id="cust_update">City</label>
                            <input type="text" name="ucity" class="form-control" placeholder="City" value="<?php echo $category[0]->s_city; ?>" />
                </div>
                <div class="form-group col-md-6">
                <label for="companyinput1" id="cust_update">Pincode</label>
                            <input type="text" name="upincode" class="form-control" placeholder="Pincode" value="<?php echo $category[0]->s_pincode; ?>" />
                </div>
                <div class="form-group col-md-6">
                <label for="companyinput1" id="cust_update">Country</label>
                            <input type="text" name="ucountry" class="form-control" placeholder="Country" value="<?php echo $category[0]->s_country; ?>" />
                </div>
                <div class="form-group col-md-6">
                <label for="companyinput1" id="cust_update">Mobile*</label>
                            <input type="text" name="umobile" class="form-control" placeholder="Mobile" value="<?php echo $category[0]->s_mobile; ?>" />
                </div>
                <div class="form-group col-md-6">
                <label for="companyinput1" id="cust_update">Alt Mobile</label>
                            <input type="text" name="ualtmobile" class="form-control" placeholder="Alt Mobile" value="<?php echo $category[0]->s_alt; ?>" />
                </div>
                <div class="form-group col-md-6">
                <label for="companyinput1" id="cust_update">Email</label>
                            <input type="text" name="uemail" class="form-control" placeholder="Email" value="<?php echo $category[0]->s_email; ?>" />
                </div>
                <div class="form-group col-md-6">
